...
export interface ApiMedMed extends Schema.CollectionType {
  collectionName: 'meds';
  info: {
    singularName: 'med';
    pluralName: 'meds';
  ...
  attributes: {
    media_name: Attribute.String;
    media: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::med.med', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::med.med', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiWalletWallet extends Schema.CollectionType {
  ...
  attributes: {
    total_budget: Attribute.Decimal;
    total_income: Attribute.Decimal;
    total_expense: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
